...
import 'package:tutero_asteroids_game/src/repositories/asteroid_repository.dart';

class CircleAsteroidRepository implements AsteroidRepository{
  @override
  List<Asteroid> generateAsteroids({required Offset startPosition, required int minSize, required int maxSize, required int numOfAsteroid, required averageSpeed}) {
    ...
    for(var i=0;i<numOfAsteroid;i++){
      ...
      AsteroidType asteroidType = AsteroidType.circle;
